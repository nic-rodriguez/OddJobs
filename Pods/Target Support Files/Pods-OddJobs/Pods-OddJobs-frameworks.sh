...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ChatSDKCore/ChatSDKCore.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ChatSDKCoreData/ChatSDKCoreData.framework"
  install_framework "${PODS_ROOT}/../../ChatSDK/ChatSDKFirebaseAdapter/FirebaseFrameworks/Firebase.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ChatSDKFirebaseAdapter/ChatSDKFirebaseAdapter.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ChatSDKUI/ChatSDKUI.framework"
